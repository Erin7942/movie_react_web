...
// import '../js/headhesive.min.js';
// import '../js/matchHeight.min.js';
// import '../js/modernizr.custom.js';
// import '../js/slick.min.js';
// import '../js/venobox.min.js';
// import '../https://use.fontawesome.com/4dfd2d448a.js';
// import '../js/custom.js';
import './movie_test.js';
import '../App.css';
		...
		<div class="wrapper">
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="tel">
									<a href="tel:67033012345">
										<i class="material-icons">phone in talk</i> test
									</a>
								</div>
							</div>
						</div>
			...
			<div id="hero" class="carousel slide carousel-fade" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active" style={{backgroundImage: "url(http://via.placeholder.com/1140x665)"}}>
						{/* <!-- Content --> */}
						<div class="container">
					...
					<div class="row comingSoon-slides">
						<div class="col-sm-12">
							...
							<div class="row single-slide slideOne">
								<div class="bg" style={{backgroundImage: "url(http://via.placeholder.com/1440x880)"}}></div>
